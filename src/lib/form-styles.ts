...
export const inputClassName = [
  "flex h-9 w-full rounded-md border border-input bg-background px-3 text-sm text-foreground placeholder:text-muted-foreground",
  focusRing,
  disabled,
].join(" ")
...
export const inputClassNameLg = [
  "h-10 w-full rounded-md border border-input bg-background px-3 text-sm text-foreground outline-none transition-colors placeholder:text-muted-foreground",
  focusRing,
  disabled,
].join(" ")
...
export const inputClassNameLgNoFull = [
  "h-10 rounded-md border border-input bg-background px-3 text-sm text-foreground outline-none transition-colors placeholder:text-muted-foreground",
  focusRing,
  disabled,
].join(" ")
...
export const selectStyleInputSm = [
  "h-8 w-full rounded-md border border-input bg-background px-3 text-sm text-foreground outline-none transition-colors",
  focusRing,
  disabled,
].join(" ")
...
export const selectStyleInputSmPx2 = [
  "h-8 w-full rounded-md border border-input bg-background px-2 text-sm text-foreground outline-none transition-colors",
  focusRing,
  disabled,
].join(" ")
...
export const textareaClassName = [
  "flex min-h-[80px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm leading-5 placeholder:text-muted-foreground",
  focusRing,
  disabled,
].join(" ")
