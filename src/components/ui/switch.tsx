  ...
  ({ className, checked = false, onCheckedChange, onClick, disabled, ...props }, ref) => {
    return (
      ...
      >
        <span
          data-state={checked ? "checked" : "unchecked"}
          className="pointer-events-none block h-4 w-4 rounded-full bg-white ring-0 transition-transform data-[state=unchecked]:translate-x-0 data-[state=checked]:translate-x-4"
        />
      </button>
    )
  }
